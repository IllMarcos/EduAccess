...
const LoginScreen = () => {
  ...
  const handleLogin = () => {
    ...
    signInWithEmailAndPassword(auth, email, password)
      .then(() => {
        // --- FUNCIÓN RESTAURADA ---
        // Redirige a la raíz, y el _layout decidirá el destino final.
        router.replace('/');
      })
      .catch(() => {
...
const styles = StyleSheet.create({
    ...
    title: { 
      fontSize: 28, fontFamily: 'Montserrat_700Bold', color: '#1a202c', textAlign: 'center', marginBottom: 8,
    },
    subtitle: {
      fontSize: 16, fontFamily: 'Montserrat_400Regular', color: '#4a5568', textAlign: 'center', marginBottom: 40,
    },
    input: { 
      width: '100%', borderBottomWidth: 1, borderColor: '#ccc', paddingVertical: 12, paddingHorizontal: 6, fontFamily: 'Montserrat_400Regular', fontSize: 16, color: '#1a202c', marginBottom: 25,
    },
    errorText: { 
      color: '#e14943', textAlign: 'center', marginBottom: 20, fontFamily: 'Montserrat_400Regular',
    },
    buttonAction: {
      backgroundColor: '#e8716d', borderRadius: 8, paddingVertical: 16, alignItems: 'center', marginTop: 20,
    },
    buttonDisabled: {
      backgroundColor: '#fbd9d7',
    },
    buttonActionText: {
      fontSize: 16, fontFamily: 'Montserrat_500Medium', color: '#fff', textTransform: 'uppercase', letterSpacing: 1,
    },
    footer: {
      flexDirection: 'row', justifyContent: 'center', marginTop: 30,
    },
    footerText: {
      fontFamily: 'Montserrat_400Regular', color: '#4a5568', fontSize: 14,
    },
    linkText: {
      fontFamily: 'Montserrat_700Bold', color: '#e8716d', fontSize: 14,
    }
});
